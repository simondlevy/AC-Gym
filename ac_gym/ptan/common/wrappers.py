...
class EpisodicLifeEnv(gym.Wrapper):
    ...
    def reset(self):
        '''
        Reset only when lives are exhausted.  This way all states are still
        reachable even though lives are episodic, and the learner need not
        know about any of this behind-the-scenes.
        '''
...
class LazyFrames(object):
    def __init__(self, frames):
        ...
        be huge for DQN's 1M frames replay buffers.  This object should only
        be converted to numpy array before being passed to the model.
